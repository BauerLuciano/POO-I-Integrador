...
## Project Information
- **Project path**: d:/Facultad/POO I/POO-I-Integrador
- **Working branch**: appmod/java-upgrade-20260107184350
...
- **Target JDK path (Java 21)**: C:\Users\lucia\AppData\Roaming\Code\User\globalStorage\pleiades.java-extension-pack-jdk\java\21\bin
- **Build tool type**: Maven
- **Build tool path**: C:\Users\lucia\.maven\maven-3.9.12\bin
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20260107184350`.
